            ...
            <div class="testimonial-box">
                <div class="container">
                    <div class="center">
                        ...
                        $result = mysqli_query($conn,"SELECT pdf, imge FROM pub  where pubtype = 'research' order by pubdate desc, impfac desc limit 3; ");
                ...
                <div class="testimonial-box">
                    <div class="container">
                        <div class="center">
                            <?php
                            $conn = mysqli_connect("localhost","root","","login_register_pure_coding");
                            $result = mysqli_query($conn,"SELECT pdf, imge FROM pub  where pubtype = 'research' order by impfac desc limit 3; ");
                            $n=mysqli_num_rows($result);
                            $i = 0;
                            echo '<table cellspacing="3" cellpadding="4" cellspacing="9" border="1"><tr>';
                            if ($result) {
