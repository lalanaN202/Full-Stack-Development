        ...
        <section id="team">
            ...
            <div class="testimonial-box">
                <div class="container">
                    ...
                    $result = mysqli_query($conn,"SELECT pdf, imge FROM pub  where pubtype = 'articles' order by pubdate desc, impfac desc limit 3; ");
            ...
            <section id="team">
                ...
                <div class="container">
                    <div class="center">
                        <?php
                        $conn = mysqli_connect("localhost","root","","login_register_pure_coding");
                        $result = mysqli_query($conn,"SELECT pdf, imge FROM pub  where pubtype = 'articles' order by impfac desc limit 3; ");
