            ...
            <div class="testimonial-box">
                <div class="container">
                    <div class="center">
                                    ...
                                    $result = mysqli_query($conn,"SELECT pdf, imge FROM pub  where pubtype = 'books' order by pubdate desc, impfac desc limit 3; ");
                ...
                <div class="testimonial-box">
                    <div class="container">
                        <div class="center">
                                    <?php
                                    $conn = mysqli_connect("localhost","root","","login_register_pure_coding");
                                    $result = mysqli_query($conn,"SELECT pdf, imge FROM pub where pubtype = 'books' order by impfac desc limit 3; ");
                                    $n=mysqli_num_rows($result);
                                    $i = 0;
                                    echo '<table cellspacing="3" cellpadding="4" cellspacing="9" border="1"><tr>';
                                    if ($result) {
                                        while($row = mysqli_fetch_array($result)) {
                                            ...
                                            $c4 = 'info-area a';
                                            if($i%3==0) {
                                                echo    '<tr><td><div class="img-area '.$c2.'"><img alt="" class="image" src="pdf/'.$row['imge'].'"  width=200 height=300></div>
                                                                    <div class="info-area '.$c3.''.$c4.'">
